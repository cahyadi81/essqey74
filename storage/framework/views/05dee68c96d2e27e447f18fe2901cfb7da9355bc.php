  ...
  <script>
    ...
    $dtbl = $('#table').DataTable({
       ...
       ajax: {
         ...
         url: "http://phpstack-160315-572402.cloudwaysapps.com/api/<?php echo e($target); ?>/login/data/user?pass=$2y$12$pEtbFeVYpdXlP9CmVjffhuEk9WDM0pCbTjmVnWgO9qgQo.U0OtsX2",
         type: "GET",
         crossDomain: true,
         headers: {
    ...
    function force_logout(username){
      ...
      $.ajax({
        type: 'POST',
        url: "http://phpstack-160315-572402.cloudwaysapps.com/api/<?php echo e($target); ?>/login/data/user/logout?username="+username,

...
<?php $__env->startSection('body'); ?>
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form id="loginform" action="<?php echo e(url(config('adminlte.login_url', 'login'))); ?>" method="post">
                <?php echo csrf_field(); ?>


                <div class="form-group has-feedback <?php echo e($errors->has('nik') ? 'has-error' : ''); ?>">
                    <input type="nik" id="nik" name="nik" class="form-control" value="<?php echo e(old('nik')); ?>"
            ...
            <div class="auth-links">
                ...
                <br>
                <?php if(config('adminlte.register_url', 'admin/register')): ?>
                    <a href="<?php echo e(url(config('adminlte.register_url', 'admin/register'))); ?>"
                       class="text-center"
